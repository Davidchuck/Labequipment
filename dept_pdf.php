...
<div style="font-size: 12px">
  ...
  echo " <b>  Equipment List $Dept Department </b>  <br> <hr>";



  
	$result = mysqli_query($con,"select * from  equipment_master where Department LIKE '%$Dept%' "); 
...
<table border='1' cellspacing=''>
  <tr><td> Eqp_NoID</td> <td>NDL:EQP:$Eqp_NoID</td>   </tr>
 ...
 <tr><td> Installation date</td>    <td>$Installation_date</td>   </tr>
  ...
  <tr><td>Supplier phone</td>  <td>0$Supplier_phone</td>   </tr>
